...
Plot is difficult to get values from, will use less values to make more clear. I have experimented with 5 different values to see which can provide important information without overloading the user with unneeded data points. 
